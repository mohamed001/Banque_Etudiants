...
<form  method="POST" action="RETRAIT.php" name="form" >
<?php 
	...
	?>
				...
				<p>SOLDE  ACTUEL :<p/>
					<input type="text" id="idc" value="<?php echo $row['SOLDE_ACTUEL'];?>"   readonly="true"/>
					
			
				<p>SOLDE A RETIRER  :<p/>
					<input type="text" id="nom"   name="monttretr" /><br><br>
